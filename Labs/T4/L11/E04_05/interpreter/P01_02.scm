...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; E04_04: Add representation for "and" and "or" expressions

(define (and? exp) (tagged-list? exp 'and))
(define (or? exp) (tagged-list? exp 'or))

; Selectors for the expression
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; E04_05: Add representation for extended "cond" expression

(define (extended-cond? exp) 
  ; Extended cond expressions have three elements in each clause:
  ; ((assoc (quote b) (quote ((a 1) (b 2)))) => cadr)
  ; 1. (assoc (quote b) (quote ((a 1) (b 2))))
  ; 2. => 
  ; 3. cadr
  (= 
    (length 
      (car (cond-clauses exp))
    )
    3
  )
)
...
; The actions are the third element of the clause (is a procedure, so do caddr instead of cddr
; that will return "(procedure)" instead of "procedure")
(define (extended-cond-actions clause) (caddr clause))
; A clause is an else if the predicate equals "else"
(define (extended-cond-else-clause? clause)
  (eq? (cond-predicate clause) 'else)
)
; Obtain list of all clauses
(define (extended-cond-clauses exp) (cdr exp))
; Obtain first clause of list of clauses
(define (extended-cond-first-clause clauses) (car clauses))
; Obtain rest clauses of list of clauses
(define (extended-cond-rest-clauses clauses) (cdr clauses))
